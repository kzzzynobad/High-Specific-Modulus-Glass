...
# 示例模型
model = RandomForestRegressor(n_estimators=331, max_depth=35, min_samples_leaf=1, min_samples_split=2, random_state=42, n_jobs=-1)
...
# shap.save_html(r'C:\Users\15198\Desktop\ML1/shap_plot.html', shap_plot)
